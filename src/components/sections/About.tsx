        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            ...
            <motion.div variants={fadeUp} className="relative">
              ...
              <div className="aspect-square rounded-2xl glass-panel p-8 flex items-center justify-center overflow-hidden relative">
                ...
                <div className="text-center relative z-10">
                  <span
                    className="text-8xl md:text-9xl font-bold text-gradient-primary block"
                    style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                  >
                    B
                  </span>
                  <span className="text-primary text-6xl font-bold -mt-4 block" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                    .
                  </span>
            ...
            <div className="space-y-6">
              ...
              <motion.p variants={fadeUp} className="text-muted-foreground leading-relaxed">
                When I&apos;m not coding, I&apos;m mentoring developers, contributing to open source, or exploring
                the latest in{' '}
                <span className="text-foreground font-medium">cloud-native infrastructure</span>.
                I believe the best software is built by people who care about both the code and the people who use it.
              </motion.p>
